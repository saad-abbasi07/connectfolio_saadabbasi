...
export default function Home() {
  ...
  return (
    <section className="bg-neutral-900 text-white min-h-screen flex items-center w-full px-6 py-16">
      <div className="max-w-6xl w-full mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <p className="text-gray-300 text-lg sm:text-xl max-w-lg mx-auto md:mx-0">
            ...
            I build responsive, scalable applications and analyze data to create solutions for real-world problems.
          </p>

          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 mt-4">
            <Link
              to="/projects"
              className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-full shadow-lg transition-all duration-300"
            >
              View Projects
            </Link>
            <Link
              to="/contact"
              className="border-2 border-gray-400 text-gray-300 hover:border-purple-400 hover:text-white px-6 py-3 rounded-full transition-all duration-300"
            >
              Contact Me
            </Link>
          </div>
